...
import { create, list, get, submit, approve, reject, dealHealth, getDealHealth } from "../controllers/quotation.controller.js";
...
router.post("/:id/approve", requireAuth, requireRole("MANAGER"), approve);
router.post("/:id/reject", requireAuth, requireRole("MANAGER"), reject);
