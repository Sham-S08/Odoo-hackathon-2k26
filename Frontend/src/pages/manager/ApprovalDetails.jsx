...
export default function ApprovalDetails() {
  ...
  // Get the specific approval data based on ID from the unified map
    ...
    <div>
      ...
      <div className="grid grid-cols-1 gap-5 lg:grid-cols-3">
        ...
        <div className="space-y-5 lg:col-span-2">
          ...
          {/* Rule Violations - only show if any */}
          ...
          {/* Version Comparison - only if previous version exists */}
        ...
        <div className="space-y-5">
            ...
            <Card>
              <ApprovalActions 
                onDecision={(action, reason) => {
                  // This will update the parent state in Approvals.jsx
                  // The callback passes up to the parent component
                }}
          ...
          {/* Decision Summary if already acted */}
